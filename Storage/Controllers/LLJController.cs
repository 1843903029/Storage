...
namespace Storage.Controllers
{
    public class LLJController : Controller
    {
        ...
        public ActionResult caidandel(string NodeId)
        {

            return Json(BLL.LLJ.CanDanManager.caidandel(NodeId), JsonRequestBehavior.AllowGet);
        }
        //
        public ActionResult FunctionGetById(string NodeId)
        {
        ...
        //修改
        public ActionResult FunctionEdit(string NodeId, string DisplayName)
        {
